    ...
    <div className="max-sm:flexCenter max-xs:pb-3 rounded bg-white pb-3 sm:w-1/5 sm: min-h-screen">
      <div className="flex flex-col gap-y-6 max-sm:items-center sm:flex-col pt-4 sm:pt-14">
        ...
        <Link to={"/"} className="bold-24 flex items-baseline sm:pl-12">
          ...
          <span className="text-secondary pl-2 sm:hidden lg:flex">Goluf</span>
        </Link>
        <div className="flex sm:flex-col gap-x-5 gap-y-8 sm:pl-10">
          <NavLink
            to={"/"}
            className={({ isActive }) =>
              isActive
          ...
          {/* Logout button at the bottom in large screen, at the end on small screen */}
