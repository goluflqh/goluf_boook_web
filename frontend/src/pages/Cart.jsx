...
const Cart = () => {
  ...
  return (
    <section className='max-padd-container'>
      <div className='pt-28'>
        {/* Title */}
        <Title title1={'Cart'} title2={'List'} titleStyle={'h3'} />
        {/* Cart Items */}
        <div className='mt-6'>
          {books.map((item)=>{
              ...
              return(
                <div key={item._id} className='bg-white p-2 mt-3 rounded-lg'>
                  <div className='flex gap-x-3'>
                    <div className='dlex items-start gap-6'>
                      ...
                      <div className='flex items-start justify-between'>
                        <div>
                          ...
                          <div className='flex items-center ring-1 ring-slate-900/5 rounded-full overflow-hidden bg-primary'>
                            ...
                            <p className='px-3'>{cartItems[item._id]}</p>
                        ...
                        <h4 className='h4'>{currency}{item.price * cartItems[item._id]}</h4>
