...
const CartTotal = () => {
  ...
  return (
    <div className='w-full'>
      {/* Title */}
      <Title title1={'Cart'} title2={'Total'} titleStyle={'h3'} />
      ...
      <div className='flexBetween pt-3'>
        ...
        <p className='h5'>{getCartAmount() === 0 ?"0.00" :`${currency}${delivery_charge}.00`}</p>
      </div>
      <hr className='mx-auto h-[1px] w-full bg-gray-900/10 my-1 '/>
      <div className='flexBetween pt-3'>
        <h5 className='h5'>Total:</h5>
        <p className='h5'>{currency}{getCartAmount() ===0 ? "0" :getCartAmount() + delivery_charge}.00</p>
      </div>
      <hr className='mx-auto h-[1px] w-full bg-gray-900/10 my-1 '/>
    </div>
